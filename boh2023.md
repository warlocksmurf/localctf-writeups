...
<img src="https://github.com/warlocksmurf/ctf-writeups/assets/121353711/6abd73b5-b584-47e2-91c9-7f10ad99c44c" alt="pokemon1" width=70% height=70%>

Ok we know the card name and number, but it seems that the error type and grade is not present for some reason. So I tried to just Google the cert number for Charizard VSTAR and found an Instagram reel on a charizard card error.

<img src="https://github.com/warlocksmurf/ctf-writeups/assets/121353711/6fe90353-0066-478b-8de1-77127eb4a70c" alt="pokemon2" width=50% height=50%>

Zooming into the card, the cert number proves that this is the card we are looking for, and hence the flag too.

<img src="https://github.com/warlocksmurf/ctf-writeups/assets/121353711/531cb360-f9bb-40ee-a839-1744c6d9b838" alt="spy-kids-lemme-zoom-in-on-that" width=50% height=50%>
